#!/bin/bash
#SBATCH --job-name=AOGPT-S-NoCL           # Job name
...
#SBATCH --output=slurm_logs/AOGPT_S_NoCL_%j.log        # Standard output and error log
#SBATCH --error=slurm_logs/AOGPT_S_NoCL_%j.err
#SBATCH --exclusive
...
srun torchrun \
    ...
    train_AOGPT_CL.py config_larger_model_v3/train_AOGPT_AdaLN6_NoRep_cond_128_NoCL.py
