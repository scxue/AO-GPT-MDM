...
def get_dataloaders(train_dataset, valid_dataset, batch_size, cache_dir, block_size, distributed, n_proc):


    train_set = get_dataset(train_dataset, "train", cache_dir=cache_dir, block_size=block_size, num_proc=n_proc)
    valid_set = get_dataset(valid_dataset, "validation" if valid_dataset != "text8" else "test", cache_dir=cache_dir, block_size=block_size)
...
def get_valid_dataloaders(dataset_name, batch_size, cache_dir, block_size, distributed):

    if dataset_name != "wikitext2":
        dataset = get_dataset(dataset_name, "test", cache_dir=cache_dir, block_size=block_size)
    else:
        dataset = get_dataset(dataset_name, "train", cache_dir=cache_dir, block_size=block_size)
