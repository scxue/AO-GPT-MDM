...
cache_dir = '/home/cache' # your cache for data
...
# MDM settings
# model(X, mode='Random_CL', random_ratio=0.9)
train_mode = 'Random_CL'
random_ratio = 0.9
...
while True:
    ...
    for micro_step in range(gradient_accumulation_steps):
        ...
        with ctx:
            logits, loss = model(X, mode=train_mode, random_ratio=random_ratio)
